...
from fusioncharts.samples import simple, dict_json_example, dict_xml_example
from fusioncharts.samples import fusion_maps, angular_gauge_example
...
from fusioncharts.samples import fetching_data_from_json_url, fetching_data_from_xml_url
