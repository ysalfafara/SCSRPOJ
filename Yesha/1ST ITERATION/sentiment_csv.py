...
data = csv.reader(open('C:/Users/Yesha/Desktop/SVM/Train2.csv'), delimiter=",")
...
def main():
    ...
    for tweet in sys.stdin:
        if predict(tweet, classifier) == 1:
            print('pos')
        elif predict(tweet, classifier) == 0:
            print('neg')
    ...
    #     if predict(tweet, classifier) == 1:
    #         print('pos')
    #         sentiment.append(predict(tweet, classifier))
    #     elif predict(tweet, classifier) == 0:
    #         print('neg')
    #         sentiment.append(predict(tweet, classifier))
    #
    # with open(r'Train3.csv', 'a') as f:
    #     writer = csv.writer(f)
